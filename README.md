...
[![Sentiment video](https://github.com/ElizaClapa/LLM-Project-LHL/blob/main/Images%20-%20Videos/3%20Stars.png?raw=true)](https://youtu.be/2eHn0dAzdfM)
...
2. **Shopify App Development**: A custom Shopify app can be developed to incorporate the recommendation engine directly into the store’s interface. This app would provide an interface for the engine to interact with the store’s product catalog and customer data.
